 ...
 * @author Tian.Dong
 */
public class BatchCheckEmail {
    public static void main(String[] args) throws IOException {
        for (int i = 101; i <= 300; i++) {
            HttpClient client = HttpClientUtil.getHttpClient();
//            String username = "dtph" + i;
...
//            String email = "ntegbk30241@chacuo.net";
            ...
            String getMailHtml = getEmail(client, cookie, email);
            if(getMailHtml.contains("您的邮箱地址已验证通过")) {
                System.out.println(username+"通过");
            } else {
                System.out.println(username+"不通过");
...
//                "532373886%40qq.com" +
    ...
    public static String getEmail(HttpClient client, String cookie, String email) throws IOException {
