...
import tk.gbl.core.script.work.activity.ErQiaoAction;
 ...
 * @author Tian.Dong
 */
public class MainTankActivity2qiaoWork {
    ...
    public static void main(String[] args) throws IOException {
        ...
        gameClient1.setUsername("wp47809");
        ...
        gameClient3.setUsername("wp47811");
        ...
        gameClient4.setUsername("wp47812");
        ...
        gameClient5.setUsername("wp47813");
...
//            e.printStackTrace();
//        }
        if (gameClient1.getCurrentMapId() == 12921) {
            gameClient1.simpleMove(2);
        }
        if(gameClient2.getCurrentMapId() == 12921) {
            gameClient2.simpleMove(2);
        }
        if(gameClient3.getCurrentMapId() == 12921) {
            gameClient3.simpleMove(2);
        }
        if(gameClient4.getCurrentMapId() == 12921) {
            gameClient4.simpleMove(2);
        }
        if(gameClient5.getCurrentMapId() == 12921) {
            gameClient5.simpleMove(2);
        }

        gameClient1.getAllowTeamUsers().clear();
        gameClient1.getAllowTeamUsers().add(47810L);
        gameClient1.getAllowTeamUsers().add(47811L);
        ...
        gameClient1.doScriptAction(new ErQiaoAction());
