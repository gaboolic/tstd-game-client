 ...
 * @author Tian.Dong
 */
public class ThrowPearAction extends ScriptAction {
    @Override
    public void doAction(GameClient gameClient) throws IOException {
        ...
        gameClient.segmentMoveTo(1010, 1160);//邺城广场 小绿豆对话
        Random randomNumberGenerator = new Random();
        int xPos = randomNumberGenerator.nextInt(100) - 50;
        int yPos = randomNumberGenerator.nextInt(100) - 50;
        gameClient.segmentMoveTo(1010 + xPos, 1160 + yPos);
