 ...
 * @author Tian.Dong
 */
public class FightBossDuizhangAi extends BaseFightAi{
...
//                gameClient.fight(fromPosition, fromPosition, SkillType.zhendian.getId());
//                gameClient.fight(fromPosition2, fromPosition2, SkillType.foguangzhang.getId());
